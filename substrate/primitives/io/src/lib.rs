...
use sp_core::bls381; // Removed ecdsa_bls381 for quantum-safety
...
pub trait Crypto {
	...
	// QUANTUM-VULNERABLE: ecdsa_bls381 removed for quantum safety (contains ecdsa)
